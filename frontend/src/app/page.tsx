...
type PostData = {
  ...
  hashtags: string;
  created_at: string;
  stats: { platform: string; views: number; likes: number; saves: number; views_1h: number; drop_off_rate: number }[];
};
      ...
      .catch(() => {
        ...
        setPosts([
          ...
          },
          {
            ...
            created_at: new Date().toISOString(),
            stats: [
              { platform: "youtube", views: 42000, likes: 3200, saves: 1100, views_1h: 15000, drop_off_rate: 25.3 },
              { platform: "tiktok", views: 38900, likes: 2900, saves: 930, views_1h: 14000, drop_off_rate: 52.7 },
              { platform: "instagram", views: 31200, likes: 4500, saves: 1700, views_1h: 11000, drop_off_rate: 19.8 },
            ],
          },
          {
            ...
            created_at: new Date().toISOString(),
            stats: [
              { platform: "youtube", views: 7500, likes: 930, saves: 400, views_1h: 2800, drop_off_rate: 38.9 },
              { platform: "tiktok", views: 25500, likes: 2000, saves: 800, views_1h: 9500, drop_off_rate: 31.5 },
              { platform: "instagram", views: 4800, likes: 500, saves: 240, views_1h: 1800, drop_off_rate: 48.2 },
            ],
          },
        ]);
        setLoading(false);
        ...
        <div className="kpi-grid">
          {(["youtube", "tiktok", "instagram"] as const).map((platform) => (
            <PlatformCard
              ...
              highlights={dashboard.highlights as { views: string; likes: string; saves: string }}
            />
          ))}
        </div>
      )}
